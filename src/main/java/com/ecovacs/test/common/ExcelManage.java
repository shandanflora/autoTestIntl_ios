...
public class ExcelManage {
    ...
    public void writeRow(int iRow, ExcelRow excelRow, boolean bPass){
        ...
        try {
            ...
            fileLink5.setAddress("screenShots/doResetPass-" + excelRow.getCountry() + ".png");
            row.getCell(5).setHyperlink(fileLink5);
            row.getCell(5).setCellStyle(hlink_style);
            //reset password.png
            row.createCell(6).setCellValue("click for view");
            fileLink6.setAddress("screenShots/Register-" + excelRow.getCountry() + ".png");
